...
export default function CoastalOriginal() {
  ...
  useEffect(() => {
    // تُحمّل كل أصول الساحل والبركان والثلوج في Home قبل تركيب هذه الصفحة.
    // لذلك لا ننتظر oncanplaythrough مجددًا داخل الساحل، حتى لا يتوقف العرض بعد تدوير الجهاز.
    setAssetsReady(true);
